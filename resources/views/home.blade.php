...
<!-- Mirrored from jufailitech.com/envatoitems/travilo/html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Nov 2023 12:52:30 GMT -->
<head>
	<meta charset="utf-8">
	<!-- Responsive -->
	...
	<link href="./css/lib/fontawesome/css/fontawesome.min.css" rel="stylesheet">
	<link href="./css/lib/fontawesome/css/brands.css" rel="stylesheet">
	<link href="./css/lib/fontawesome/css/solid.css" rel="stylesheet">
	<link href="./css/lib/simple-line-icons/css/simple-line-icons.min.css" rel="stylesheet">
	<link href="./css/lib/flaticon/css/flaticon.min.css" rel="stylesheet">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide slide-item">
							<div class="image-layer"
								style="background-image: url(./images/resources/slider/main-slider-1.jpg);"></div>
						...
						<div class="swiper-slide slide-item">
							<div class="image-layer"
								style="background-image: url(./images/resources/slider/main-slider-2.jpg);"></div>
							<div class="auto-container">
								<div class="content-box">
									<div class="content">
										<div class="clearfix">
						...
						<div class="swiper-slide slide-item">
							<div class="image-layer"
								style="background-image: url(./images/resources/slider/main-slider-3.jpg);"></div>
							<div class="auto-container">
								<div class="content-box">
									<div class="content">
										<div class="clearfix">
						...
						<div class="swiper-slide slide-item">
							<div class="image-layer"
								style="background-image: url(./images/resources/slider/main-slider-4.jpg);"></div>
							<div class="auto-container">
								<div class="content-box">
									<div class="content">
										<div class="clearfix">
			...
			<div class="auto-container">
				...
				<div class="row clearfix justify-content-center">
					...
					<div class="intro-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0ms"
						...
						<div class="inner-box">
							<div class="icon"><span><img src="./images/icons/intro-1.png" alt=""></span></div>
					...
					<div class="intro-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms"
						data-wow-duration="1500ms">
						<div class="inner-box">
							<div class="icon"><span><img src="./images/icons/intro-2.png" alt=""></span></div>
					...
					<div class="intro-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms"
						data-wow-duration="1500ms">
						<div class="inner-box">
							<div class="icon"><span><img src="./images/icons/intro-3.png" alt=""></span></div>
            ...
            @foreach($flights as $flight)
                                ...
                                <div class="inner-box">
										<div class="image-box">
                                            ...
                                            <div class="b-description"><span style="margin-top:20px;">{{ $flight->short_description }}</span></div>

											<div class="fav-btn"><a href="#"><span class="far fa-heart"></span></a>
											</div>
										</div>
										<div class="lower-box">
											<div class="location">{{ $flight->name }}</div>
											<div class="bottom-box clearfix">
												<div class="rating"><a href="#" class="theme-btn"><i
															class="fa-solid fa-star"></i>
														<strong>{{$flight->rate}}</strong> &ensp;
														<span class="guests">guests:{{$flight->guests}}</span></a></div>
												<div class="price">Start from &ensp;<span class="amount">${{$flight->price}}</span>
												</div>
											</div>
										</div>
									</div>
...
<!-- Mirrored from jufailitech.com/envatoitems/travilo/html/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Nov 2023 12:53:05 GMT -->
</html>
@endsection
