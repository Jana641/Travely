							...
							<div class="footer-column col-xl-4 col-lg-3 col-md-6 col-sm-12">
								<div class="footer-widget about-widget">
									<div class="footer-logo"><a href="index-2.html" title="Travilo"><img
												src="{{asset('./images/logo-white.png')}}" alt="" title="Travilo"></a></div>
							...
							<div class="footer-column col-xl-3 col-lg-3 col-md-6 col-sm-12">
								<div class="footer-widget app-widget">
									...
									<div class="app-info">
										...
										<div class="links">
											<div class="link"><a href="#"><img src="{{asset('./images/apple-store.png')}}"
														alt=""></a></div>
											<div class="link"><a href="#"><img src="{{asset('./images/play-store.png')}}"
														alt=""></a></div>
										</div>
									</div>
								</div>
